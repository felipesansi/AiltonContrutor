...
namespace AiltonContrutor.Areas.Admin.Controllers
{
    ...
    public class AdminImovelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdImovel,Titulo,Descricao,Quartos,Banheiros,AreaGourmet,Churrasqueira,Piscina,Valor,ImagemUrl,ImagemThumbnailUrl,StatusImovel,CategoriaId")] Imovel imovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdImovel,Titulo,Descricao,Quartos,Banheiros,AreaGourmet,Churrasqueira,Piscina,Valor,ImagemUrl,ImagemThumbnailUrl,StatusImovel,CategoriaId")] Imovel imovel)
        {
